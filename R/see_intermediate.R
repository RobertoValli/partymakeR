...
#'
#' @description This function assumes a standardized RProject folder structure with a "data_intermediate" folder at top level. The function is a wrapper of \code{\link[here]{here}} and allows to quickly inspect files and folders.
